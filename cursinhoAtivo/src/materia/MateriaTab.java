 ...
 * @author JSQLGen
 */
public class MateriaTab extends javax.swing.JDialog {
    private final java.sql.Connection connection;
    private final java.util.List list;

    /** Construtor do form MateriaTab
     * @param parent
     * @param connection
     */
    public MateriaTab(java.awt.Window parent, java.sql.Connection connection) {
        super(parent);
    ...
    public static void showDialog(java.awt.Window parent, java.sql.Connection connection){
        new MateriaTab(parent, connection);
    }
    ...
    private void refresh() {
        ...
        list.removeAll(list);
        list.addAll(MateriaDAO.loadView(connection));
    ...
    private void initComponents() {
        ...
        setTitle("Tabela de Materia");
        setModal(true);
        tTable.setModel(new javax.swing.table.DefaultTableModel(
            new Object [][] {
            },
            new String [] {
                "Id", "CodMateria", "Nome", "NomeAbrev", "Descricao"
            }
        ) {
    ...
    private void bAddActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_bAddActionPerformed
        ...
        materia = MateriaForm.showInputDialog(this, connection, materia);
        if(materia!=null) {
            try {
                MateriaDAO.insert(connection, materia);
                refresh();
    ...
    private void bRemActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_bRemActionPerformed
        if(tTable.getSelectedRow()>=0) {
            try {
                Materia materia = MateriaDAO.loadById(connection, (Integer)tTable.getValueAt(tTable.getSelectedRow(), 0));
                if(javax.swing.JOptionPane.showConfirmDialog(this, "Deseja excluir o Materia "+materia.getId()+"?","Questão",javax.swing.JOptionPane.OK_CANCEL_OPTION)==javax.swing.JOptionPane.OK_OPTION) {
                    MateriaDAO.delete(connection, materia);
    ...
    private void bEditActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_bEditActionPerformed
        if(tTable.getSelectedRow()>=0) {
            try {
                ...
                materia = MateriaForm.showInputDialog(this, connection, materia);
                if(materia!=null) {
                    MateriaDAO.update(connection, materia);
                    refresh();
                }
            } catch(java.sql.SQLException e){
                e.printStackTrace();
    ...
    private void bPrintActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_bPrintActionPerformed
        ...
        print += "<caption>Tabela de Materia</caption>";
        print += "<tr>";
