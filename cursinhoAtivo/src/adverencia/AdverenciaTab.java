 ...
 * @author JSQLGen
 */
public class AdverenciaTab extends javax.swing.JDialog {
    private final java.sql.Connection connection;
    private final java.util.List list;

    /** Construtor do form AdverenciaTab
     * @param parent
     * @param connection
     */
    public AdverenciaTab(java.awt.Window parent, java.sql.Connection connection) {
        super(parent);
    ...
    public static void showDialog(java.awt.Window parent, java.sql.Connection connection){
        new AdverenciaTab(parent, connection);
    }
    ...
    private void refresh() {
        ...
        list.removeAll(list);
        list.addAll(AdverenciaDAO.loadView(connection));
    ...
    private void initComponents() {
        ...
        setTitle("Tabela de Adverencia");
        setModal(true);
        tTable.setModel(new javax.swing.table.DefaultTableModel(
            new Object [][] {
            },
            new String [] {
                "Id", "Aluno", "Coord", "Data", "Observacao"
            }
        ) {
    ...
    private void bAddActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_bAddActionPerformed
        Adverencia adverencia = new Adverencia();
        adverencia = AdverenciaForm.showInputDialog(this, connection, adverencia);
        if(adverencia!=null) {
            try {
                AdverenciaDAO.insert(connection, adverencia);
                refresh();
    ...
    private void bRemActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_bRemActionPerformed
        if(tTable.getSelectedRow()>=0) {
            try {
                Adverencia adverencia = AdverenciaDAO.loadById(connection, (Integer)tTable.getValueAt(tTable.getSelectedRow(), 0));
                if(javax.swing.JOptionPane.showConfirmDialog(this, "Deseja excluir o Adverencia "+adverencia.getId()+"?","Questão",javax.swing.JOptionPane.OK_CANCEL_OPTION)==javax.swing.JOptionPane.OK_OPTION) {
                    AdverenciaDAO.delete(connection, adverencia);
    ...
    private void bEditActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_bEditActionPerformed
        if(tTable.getSelectedRow()>=0) {
            try {
                ...
                adverencia = AdverenciaForm.showInputDialog(this, connection, adverencia);
                if(adverencia!=null) {
                    AdverenciaDAO.update(connection, adverencia);
                    refresh();
                }
            } catch(java.sql.SQLException e){
                e.printStackTrace();
    ...
    private void bPrintActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_bPrintActionPerformed
        ...
        print += "<caption>Tabela de Adverencia</caption>";
        print += "<tr>";
