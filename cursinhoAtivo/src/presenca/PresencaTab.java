 ...
 * @author JSQLGen
 */
public class PresencaTab extends javax.swing.JDialog {
    private final java.sql.Connection connection;
    private final java.util.List list;

    /** Construtor do form PresencaTab
     * @param parent
     * @param connection
     */
    public PresencaTab(java.awt.Window parent, java.sql.Connection connection) {
        super(parent);
    ...
    public static void showDialog(java.awt.Window parent, java.sql.Connection connection){
        new PresencaTab(parent, connection);
    }
    ...
    private void refresh() {
        ...
        list.removeAll(list);
        list.addAll(PresencaDAO.loadView(connection));
    ...
    private void initComponents() {
        ...
        setTitle("Tabela de Presenca");
        setModal(true);
        tTable.setModel(new javax.swing.table.DefaultTableModel(
            new Object [][] {
            },
            new String [] {
                "Id", "Aluno", "Entrada", "Saida", "Atraso", "Observacao", "Coordenador"
            }
        ) {
    ...
    private void bAddActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_bAddActionPerformed
        ...
        presenca = PresencaForm.showInputDialog(this, connection, presenca);
        if(presenca!=null) {
            try {
                PresencaDAO.insert(connection, presenca);
                refresh();
    ...
    private void bRemActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_bRemActionPerformed
        if(tTable.getSelectedRow()>=0) {
            try {
                Presenca presenca = PresencaDAO.loadById(connection, (Integer)tTable.getValueAt(tTable.getSelectedRow(), 0));
                if(javax.swing.JOptionPane.showConfirmDialog(this, "Deseja excluir o Presenca "+presenca.getId()+"?","Questão",javax.swing.JOptionPane.OK_CANCEL_OPTION)==javax.swing.JOptionPane.OK_OPTION) {
                    PresencaDAO.delete(connection, presenca);
    ...
    private void bEditActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_bEditActionPerformed
        if(tTable.getSelectedRow()>=0) {
            try {
                ...
                presenca = PresencaForm.showInputDialog(this, connection, presenca);
                if(presenca!=null) {
                    PresencaDAO.update(connection, presenca);
                    refresh();
                }
            } catch(java.sql.SQLException e){
                e.printStackTrace();
    ...
    private void bPrintActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_bPrintActionPerformed
        ...
        print += "<caption>Tabela de Presenca</caption>";
        print += "<tr>";
