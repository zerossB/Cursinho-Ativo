 ...
 * @author JSQLGen
 */
public class PresencaProfTab extends javax.swing.JDialog {
    private final java.sql.Connection connection;
    private final java.util.List list;

    /** Construtor do form PresencaProfTab
     * @param parent
     * @param connection
     */
    public PresencaProfTab(java.awt.Window parent, java.sql.Connection connection) {
        super(parent);
    ...
    public static void showDialog(java.awt.Window parent, java.sql.Connection connection){
        new PresencaProfTab(parent, connection);
    }
    ...
    private void refresh() {
        ...
        list.removeAll(list);
        list.addAll(PresencaProfDAO.loadView(connection));
    ...
    private void initComponents() {
        ...
        setTitle("Tabela de PresencaProf");
        setModal(true);
        tTable.setModel(new javax.swing.table.DefaultTableModel(
            new Object [][] {
            },
            new String [] {
                "Id", "Professor", "Entrada", "Saida", "Atraso", "Observacao", "Coordenador"
            }
        ) {
    ...
    private void bAddActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_bAddActionPerformed
        ...
        presencaProf = PresencaProfForm.showInputDialog(this, connection, presencaProf);
        if(presencaProf!=null) {
            try {
                PresencaProfDAO.insert(connection, presencaProf);
                refresh();
    ...
    private void bRemActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_bRemActionPerformed
        if(tTable.getSelectedRow()>=0) {
            try {
                PresencaProf presencaProf = PresencaProfDAO.loadById(connection, (Integer)tTable.getValueAt(tTable.getSelectedRow(), 0));
                if(javax.swing.JOptionPane.showConfirmDialog(this, "Deseja excluir o PresencaProf "+presencaProf.getId()+"?","Questão",javax.swing.JOptionPane.OK_CANCEL_OPTION)==javax.swing.JOptionPane.OK_OPTION) {
                    PresencaProfDAO.delete(connection, presencaProf);
    ...
    private void bEditActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_bEditActionPerformed
        if(tTable.getSelectedRow()>=0) {
            try {
                ...
                presencaProf = PresencaProfForm.showInputDialog(this, connection, presencaProf);
                if(presencaProf!=null) {
                    PresencaProfDAO.update(connection, presencaProf);
                    refresh();
                }
            } catch(java.sql.SQLException e){
                e.printStackTrace();
    ...
    private void bPrintActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_bPrintActionPerformed
        ...
        print += "<caption>Tabela de PresencaProf</caption>";
        print += "<tr>";
